...
# 导入的数据就是match条件下的
# response = 1是正确， = 0是错误
data <- import("../../2_Data/Generate_Data/gp_ddm_simulation_v2.csv") 
...
data_wide <- data_summary %>%
  pivot_wider(
    id_cols = c(subject, P, T, W),  # 按照 subject、P、T、W 分组，保留它们
...
ggplot(mean, aes(x = T, y = RT, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
...
ggplot(mean, aes(x = T, y = ACC, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "T", y = "ACC", 
...
ggplot(mean, aes(x = P, y = RT, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "P", y = "RT", 
...
ggplot(mean, aes(x = P, y = ACC, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "P", y = "ACC", 
...
ggplot(mean, aes(x = W, y = RT, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "W", y = "RT", 
...
ggplot(mean, aes(x = W, y = ACC, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "W", y = "ACC", 
...
ggplot(mean, aes(x = T + W, y = RT, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "M", y = "RT", 
...
ggplot(mean, aes(x = T + W, y = ACC, color = condition)) +
  geom_point(size = 2, alpha = 0.2) +                             # 数据点
  geom_smooth(method = "loess", se = TRUE, size = 1) +
  scale_color_manual(values = c("self" = "blue", "stranger" = "red")) + # 手动设置颜色
  labs(x = "M", y = "ACC", 
